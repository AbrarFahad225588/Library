...
class RegisterView(View):
    def get(self, request):
        ...
        return render(request, 'libraryf/register.html', {'user_form': user_form, 'profile_form': profile_form})
...
class LoginView(View):
    def get(self, request):
        return render(request, 'libraryf/login.html')
...
class HomeView(LoginRequiredMixin, TemplateView):
    template_name = 'libraryf/home.html'
...
class BookListView(LoginRequiredMixin, ListView):
    model = Book
    template_name = 'libraryf/book_list.html'
...
class BorrowHistoryView(LoginRequiredMixin, ListView):
    template_name = 'libraryf/borrow_history.html'
...
class DepositMoneyView(LoginRequiredMixin, FormView):
    template_name = 'libraryf/deposit.html'
...
class ReviewBookView(LoginRequiredMixin, View):
    template_name = 'libraryf/review_book.html'
...
class BookDetailView(LoginRequiredMixin, DetailView):
    model = Book
    template_name = 'libraryf/book_detail.html'
...
class AddBookView(View):
    def get(self, request):
        form = BookForm()
        return render(request, 'libraryf/add_book.html', {'form': form})
